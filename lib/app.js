...
const { validationResult, validate_registration, validate_login } = require("../middleware/validation");
...
app.post("/login", checkNotAuthenticated, validate_login, passport.authenticate("local", {
  successRedirect: "/",
